(function() {
  ...
  const aboutInit = () => {
    ...
    teamMembers.forEach((member) => {
      member.addEventListener("mouseenter", () => {
        var _a;
        (_a = member.querySelector(".member-bio")) == null ? void 0 : _a.classList.add("is-visible");
      });
      member.addEventListener("mouseleave", () => {
        var _a;
        (_a = member.querySelector(".member-bio")) == null ? void 0 : _a.classList.remove("is-visible");
      });
    });
  };
  const contactInit = () => {
  ...
  */
  ...
  function stateCard() {
    const stateCard2 = queryElement("[data-component='state-card']");
    ...
    gsapWithCSS.set(stateCardDescription, {
      y: 20,
      opacity: 0
    });
    ...
    stateCard2.addEventListener("mouseenter", () => {
      tl.play();
    });
    stateCard2.addEventListener("mouseleave", () => {
      tl.reverse();
    });
  }
  console.log("stateCard.js");
  function stateModal() {
    const stateModal2 = queryElement("[data-component='modal']");
    ...
    gsapWithCSS.set(stateModal2, { display: "none" });
    gsapWithCSS.set(stateModalBg, { opacity: 0 });
    gsapWithCSS.set(stateModalDrawer, { x: "100%" });
    function openModal() {
      const tl = gsapWithCSS.timeline();
      tl.set(stateModal2, { display: "flex" }).to(stateModalBg, {
        opacity: 1,
        duration: 0.5,
        ease: "expo.out"
      }).to(stateModalDrawer, {
    ...
    function closeModal() {
      const tl = gsapWithCSS.timeline({
        onComplete: () => gsapWithCSS.set(stateModal2, { display: "none" })
      });
    ...
    stateModalOpen == null ? void 0 : stateModalOpen.addEventListener("click", openModal);
    stateModalClose == null ? void 0 : stateModalClose.addEventListener("click", closeModal);
    stateModalBg == null ? void 0 : stateModalBg.addEventListener("click", (e) => {
